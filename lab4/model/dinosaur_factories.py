...
class DinosaurFactory(ABC):
    ...
    @abstractmethod
    def factory_method(self, field, pos_x: int, pos_y: int):
        pass


class BrontosaurusFactory(DinosaurFactory):

    def factory_method(self, field, pos_x: int, pos_y: int) -> Brontosaurus:
...
class StegosaurusFactory(DinosaurFactory):
    ...
    def factory_method(self, field, pos_x: int, pos_y: int) -> Stegosaurus:
...
class TrexFactory(DinosaurFactory):
    ...
    def factory_method(self, field, pos_x: int, pos_y: int) -> Trex:
        trex = Trex()
        trex._type = 'trex'
